...
ess<-ess|>mutate(
  ...
  agegroup.f=as.factor(case_when(
    agea>=15 & agea<25 ~ "15-24",  
    agea>=25 & agea<35 ~ "25-34",  
    agea>=35 & agea<45 ~ "35-44",  
    agea>=45 & agea<55 ~ "45-54", 
    agea>=55 & agea<65 ~ "55-64",  
    agea>=65 & agea<75 ~ "65-74",
    agea>=75  ~ "75+",  
    .default="Other"
  )),
  agegroup.fr=droplevels(agegroup.f),
