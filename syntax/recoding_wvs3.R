...
wvs<-wvs|>mutate(
  V41.f=as_factor(V41, "both"),
  V41.fr=droplevels(as_factor(V41, "both")),
  V123.f=as_factor(V123, "both"),
  V123.fr=droplevels(as_factor(V123, "both")),
  V214.f=as_factor(V214, "both"),
  V214.fr=droplevels(as_factor(V214, "both")),
  V217.f=as_factor(V217, "both"),
  V217.fr=droplevels(as_factor(V217, "both")),
  V216.f=as_factor(V216, "both"),
  V216.fr=as.factor(
  case_when(
  V216==-2 ~ "NA",
  V216==-1 ~ "DK",
  V216>=12 & V216<18 ~ "Age less than 18",
  V216>=18 & V216<26 ~ "18-25",
  V216>=26 & V216<37 ~ "26-36",
  V216>=37 & V216<48 ~ "37-47",
  V216>=48 & V216<59 ~ "48-58",
  V216>=59 & V216<70 ~ "59-69",
  V216>=70 & V216<121 ~ "More than 70")
),
...
for(vr in names(labs3[-19])){                        ### Leaving AgeCaat out
  attr(wvs[vr],"label")<-labs3[[vr]]
}
