...
wvs<-wvs|>mutate(
  V95.f=as_factor(V95, "both"),
  V95.fr=droplevels(V95.f),
  V81.f=as_factor(V81, "both"),
  V81.fr=droplevels(V81.f),
  V240.f=as_factor(V240, "both"),
  V240.fr=droplevels(V240.f),
  X003R.f=as_factor(X003R, "both"),
  X003R.f=fct_na_value_to_level(X003R.f), 
  X003R.fr=droplevels(X003R.f),
  V248.f=as_factor(V248, "both"),
  V248.fr=droplevels(V248.f),
  cow.f=as_factor(cow, "both"),
  cow.fr=droplevels(cow.f)
...
for(vr in names(labs6[-19])){                        ### Leaving AgeCaat out
  attr(wvs[vr],"label")<-labs6[[vr]]
}
