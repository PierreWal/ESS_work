...
wvs<-wvs|>mutate(
  V36.f=as_factor(V36, "both"),
  V36.fr=droplevels(as_factor(V36, "both")),
  V139.f=as_factor(V139, "both"),
  V139.fr=droplevels(as_factor(V139, "both")),
  V223.f=as_factor(V223, "both"),
  V223.fr=droplevels(as_factor(V223, "both")),
  V226.f=as_factor(V226, "both"),
  V226.f[is.na(V226.f)]<-"NA", 
  V226.fr=droplevels(as_factor(V226, "both")),
  V226.fr[is.na(V226.fr)]<-"NA",
  V225.f=as_factor(V225, "both"),
  V225.fr=as.factor(
  case_when(
  is.na(V225) ~ "NA",
  V225>=12 & V225<18 ~ "Age less than 18",
  V225>=18 & V225<26 ~ "18-25",
  V225>=26 & V225<37 ~ "26-36",
  V225>=37 & V225<48 ~ "37-47",
  V225>=48 & V225<59 ~ "48-58",
  V225>=59 & V225<70 ~ "59-69",
  V225>=70 & V225<121 ~ "More than 70")
),
...
for(vr in names(labs4[-19])){                        ### Leaving AgeCaat out
  attr(wvs[vr],"label")<-labs4[[vr]]
}
